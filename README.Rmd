...
`exeval` package provedas a reporducible worflow for *external evaluation* of a population pharmacokinetic (popPK) andpopPKPD model. The external evaluation is done using an independent dataset from which the original popPKPD model was developed.  Currently, model fit is based on  [mapbayr](https://github.com/FelicienLL/mapbayr) package. 
